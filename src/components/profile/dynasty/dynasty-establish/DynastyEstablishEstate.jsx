import DynastyEstablish from "./DynastyEstablish";
import DynastyEstate from "./DynastyEstate";
...
const DynastyEstablishEstate = ({ mode }) => {
  if (mode === 1) return <DynastyEstablish members={members_rows} />;
