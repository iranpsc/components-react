    ...
    <BackGround>
      <Modal>
        <div>
          ...
          <Info>
            آیا می خواهید کارت با شماره “ {bankFirstCardImage} ” را حذف کنید؟{" "}
          </Info>
        </div>
        <Buttons>
          <Button
            ...
            onClick={() => {
              ...
              setOpenConfirmFirstModal(false);
            }}
          >
            بله، حذف کارت{" "}
          </Button>
          <Button onClick={() => setOpenConfirmFirstModal(false)}>
            خیر، منصرف شدم
          </Button>
        </Buttons>
      </Modal>
...
export default ConfirmFirstDelete;
